...
import { FaUser, FaPlus, FaHome, FaComment, FaShoppingCart } from "react-icons/fa";
        ...
        datasets: [
            {
                ...
                data: [100.50, 120.75, 110.25, 130.00, 125.50, 140.20, 123.50],
            ...
            <div className="flex-1 flex flex-col">
                ...
                <main className="p-6 overflow-auto">
                    ...
                    <div className="bg-white p-4 rounded shadow flex flex-col items-center">
                        <h2 className="text-xl font-bold mb-4">Biểu đồ Doanh thu và Đơn hàng</h2>
