...
const menuItems = [
    ...
    {
        label: "RƯỢU VANG ĐỎ",
        href: "/products?category=red-wine",
        submenu: [
            {
                label: "Rượu Vang Đỏ Pháp",
                href: "/products?category=red-wine&origin=france",
            },
            {
                label: "Rượu Vang Đỏ Ý",
                href: "/products?category=red-wine&origin=italy",
            },
            {
                label: "Rượu Vang Đỏ Tây Ban Nha",
                href: "/products?category=red-wine&origin=spain",
            },
            {
                label: "Rượu Vang Đỏ Chile",
                href: "/products?category=red-wine&origin=chile",
            },
        ],
    },
    {
        label: "RƯỢU TRẮNG",
        href: "/products?category=white-wine",
        submenu: [
            {
                label: "Rượu Vang Trắng Pháp",
                href: "/products?category=white-wine&origin=france",
            },
            {
                label: "Rượu Vang Trắng Ý",
                href: "/products?category=white-wine&origin=italy",
            },
            {
                label: "Rượu Vang Trắng Đức",
                href: "/products?category=white-wine&origin=germany",
            },
        ],
    },
    {
